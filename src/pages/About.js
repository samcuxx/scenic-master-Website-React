...
<div class="container">
  ...
  <div class="row mb-5 pt-0 site-section">
    ...
    <div class="col-md-5 ml-auto img-overlap">
      <div class="img-1"><img src="./assets/images/sq_img_6.jpg" alt="Image" class="img-fluid img-shadow"/></div>
      <div class="img-2"><img src="./assets/images/sq_img_10.jpg" alt="Image" class="img-fluid img-shadow"/></div>
    </div>
  </div>
...
<div class="container">
  ...
  <div class="row align-items-center block__69944">
    <div class="col-lg-6 mb-5">
      <img src="./assets/images/person_6.jpg" alt="Image" class="img-fluid mb-4 rounded"/>
    ...
    <div class="col-lg-6 mb-5">
      <img src="./assets/images/person_5.jpg" alt="Image" class="img-fluid mb-4 rounded"/>
      <h3>Chintan Patel</h3>
      <p class="text-muted">Creative Director</p>
      <p class="lead">Odio nihil facilis vitae laudantium provident magni alias veniam quidem voluptatum</p>
      <p>Soluta quasi cum delectus eum facilis recusandae nesciunt molestias accusantium libero dolores repellat id in dolorem laborum ad modi qui at quas dolorum voluptatem voluptatum repudiandae voluptatibus ut? Ex vel  ad explicabo iure ipsa possimus consectetur neque rem molestiae eligendi velit?.</p>
    ...
    <div class="col-lg-4">
      <img src="./assets/images/person_3.jpg" alt="Image" class="img-fluid mb-4 rounded"/>
      <h3>Chintan Patel</h3>
      <p class="text-muted">Creative Director</p>
    ...
    <div class="col-lg-4">
      <img src="./assets/images/person_1.jpg" alt="Image" class="img-fluid mb-4 rounded"/>
      <h3>Jean Doe</h3>
      <p class="text-muted">Creative Director</p>
